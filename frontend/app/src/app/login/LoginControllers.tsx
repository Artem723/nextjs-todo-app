  ...
  return (
        <Form noValidate action={formAction}>
          <Form.Group className="mb-3" controlId="formBasicEmail">
            ...
            <Form.Control name="login" isInvalid={!!state} disabled={pending} type="email" placeholder="Enter email" />
          ...
          <Form.Group  className="mb-3" controlId="formBasicPassword">
            ...
            <Form.Control name="password" isInvalid={!!state} disabled={pending} type="password" placeholder="Password" />
          </Form.Group>
